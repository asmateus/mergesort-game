...
public class Level2 extends Level {
    ...
    public Level2(GameArea master, Watchdog dog) {
    ...
    public void setDescriptionArea() {
        ...
        content.setText(DescriptionStrings.getDescriptionLVL2("descriptions/images/"));
    ...
    public void setQuestionArea() {
        ...
        switch(this.getDog().master.getUserDifficulty()) {
            case 1:
                ...
                description = QuestionOptions.NOOB_QST_LEVEL_2;
                opts = new ArrayList<>(Arrays.asList(QuestionOptions.NOOB_LEVEL_2));
                correct = QuestionOptions.NOOB_CORRECT_LEVEL_2;
                break;
            case 2:
                this.difficulty_played = 2;
                description = QuestionOptions.ADVANCED_QST_LEVEL_2;
                opts = new ArrayList<>(Arrays.asList(QuestionOptions.ADVANCED_LEVEL_2));
                correct = QuestionOptions.ADVANCED_CORRECT_LEVEL_2;
                break;
            case 3:
                this.difficulty_played = 3;
                description = QuestionOptions.LEGENDARY_QST_LEVEL_2;
                opts = new ArrayList<>(Arrays.asList(QuestionOptions.LEGENDARY_LEVEL_2));
                correct = QuestionOptions.LEGENDARY_CORRECT_LEVEL_2;
                break;
        }

...
public class Level3 extends Level {
    ...
    public Level3(GameArea master, Watchdog dog) {
    ...
    public void setDescriptionArea() {
        ...
        content.setText(DescriptionStrings.getDescriptionLVL3("descriptions/images/"));
    ...
    public void setQuestionArea() {
        ...
        switch(this.getDog().master.getUserDifficulty()) {
            case 1:
                ...
                description = QuestionOptions.NOOB_QST_LEVEL_3;
                opts = new ArrayList<>(Arrays.asList(QuestionOptions.NOOB_LEVEL_3));
                correct = QuestionOptions.NOOB_CORRECT_LEVEL_3;
                break;
            case 2:
                this.difficulty_played = 2;
                description = QuestionOptions.ADVANCED_QST_LEVEL_3;
                opts = new ArrayList<>(Arrays.asList(QuestionOptions.ADVANCED_LEVEL_3));
                correct = QuestionOptions.ADVANCED_CORRECT_LEVEL_3;
                break;
            case 3:
                this.difficulty_played = 3;
                description = QuestionOptions.LEGENDARY_QST_LEVEL_3;
                opts = new ArrayList<>(Arrays.asList(QuestionOptions.LEGENDARY_LEVEL_3));
                correct = QuestionOptions.LEGENDARY_CORRECT_LEVEL_3;
                break;
        }
